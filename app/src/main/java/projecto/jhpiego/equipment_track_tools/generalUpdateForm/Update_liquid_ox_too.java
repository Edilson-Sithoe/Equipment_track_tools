...
public class Update_liquid_ox_too extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_update_liquid_ox_too);
        ...
        btnNExt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(average_consuming_oxygen) || TextUtils.isEmpty(last_month_consuminh) || TextUtils.isEmpty(capacity_lox_tank_m3)
                    ...
                    Assessment.assessment_model.setLiquid_oxygen_twoo(liquid_oxygen);
                    Assessment.assessment_model.setAverage_consuming_oxygen_twoo(average_consuming_oxygen);
                    Assessment.assessment_model.setLast_month_consuminh_twoo(last_month_consuminh);
                    Assessment.assessment_model.setTank_owner_twoo(tank_owner);
                    Assessment.assessment_model.setTank_owner_other_twhoo(tank_owner_other);
                    Assessment.assessment_model.setOld_system_oxygen_twoo(old_system_oxygen);
                    Assessment.assessment_model.setCapacity_lox_tank_m3_twoo(capacity_lox_tank_m3);
                    Assessment.assessment_model.setCapacity_lox_tank_ton_twoo(capacity_lox_tank_ton);
                    Assessment.assessment_model.setSystem_working_ox_tank_twoo(system_working_ox_tank);
                    Assessment.assessment_model.setCondition_system_ox_tank_twoo(condition_system_ox_tank);
                    Assessment.assessment_model.setActive_pm_program_twoo(active_pm_program);
                    Assessment.assessment_model.setActivie_carrie_by_ox_tank_twoo(activie_carrie_by_ox_tank);
                    Assessment.assessment_model.setFrequency_ox_tank_twoo(frequency_ox_tank);
                    Assessment.assessment_model.setName_maintenance_company_ox_tank_twoo(name_maintenance_company_ox_tank);
                    Assessment.assessment_model.setAverage_cost_ox_tank_twoo(average_cost_ox_tank);
                    Assessment.assessment_model.setBudget_lox_tank_twoo(budget_lox_tank);
                    Assessment.assessment_model.setLogbook_maintenance_tank_two(logbook_mainte_tank);
                    Assessment.assessment_model.setLogbook_update_ox_tank_twoo(logbook_update_ox_tank);
                    Assessment.assessment_model.setName_supply_ox_tank_twoo(name_supply_ox_tank);
                    Assessment.assessment_model.setHealth_receive_lox_twoo(health_receive_lox);
                    Assessment.assessment_model.setShortages_lox_twoo(shortages_lox);
                    Assessment.assessment_model.setSpecialized_internal_twoo(specialized_internal);
                    Assessment.assessment_model.setHow_many_tecn_available_twoo(how_many_tecn_available);
                    Assessment.assessment_model.setComment_ox_tank_twoo(comment_ox_tank);

                    Intent i = new Intent(Update_liquid_ox_too.this, FormLiquidOxTwoo.class);
                    startActivity(i);
                }
            }
        });
        btnBack.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent backLOX = new Intent(Update_liquid_ox_too.this, Update_manifold_emergency.class);
