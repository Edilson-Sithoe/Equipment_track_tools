...
import projecto.jhpiego.equipment_track_tools.generalForm.FormMedAirSystem;
import projecto.jhpiego.equipment_track_tools.generalForm.FormOxFactoryPSA;
...
public class Update_vaccum_system extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_update_vaccum_system);
        ...
        btnNExt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(capacity_system_ss) ||TextUtils.isEmpty(name_maintenance_ss)||TextUtils.isEmpty(frequency_pm_month_ss)
                    ...
                    Intent i = new Intent(Update_vaccum_system.this, FormMedAirSystem.class);
                    startActivity(i);
                }
            }
        });
        ...
        btnBack.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent vsystem = new Intent(Update_vaccum_system.this, FormOxFactoryPSA.class);
